...
!!! danger "READ THIS WITH CAUTION AND BIAS IN MIND!"

    This speech was written on **9th February 2024**, at some point during my GCSE English Language course, and *NOT* as an economics "paper" or speech. In fact, looking back, this was probably Year 10 rather then Year 11. The assignment tested how well I could ***speak and persuade*, ***not*** how accurately I could report data.
    
    I chose economics as the subject because it was, and still is, an area of personal interest. However, I knew that absolute factual commitment here was not necessary for a speech of this type, so rhetorical flair probably probably took priority.

    Note that context is important here - the speech was delivered in **Hornchurch**, within the London Borough of Havering, and *ALSO* at a Roman Catholic school 😅. This is a relatively conservative setting, and my teachers and peers generally leaned that way as well. You will see later on that this speech might use populist or shocking remarks (***deliberately, however***) to capture the attention of an audience that might otherwise switch off because they would prefer listening to a speech about football or Nigel or something.

    Looking back now as someone who has just started A Levels (including Economics now), I can see that much of the content is **normative rather than positive** - it reflects exaggeration and literary devices rather than *actual* economic analysis.

    Written in early 2024, the piece is now quite old, but I have kept it unedited on my personal website so that it can stand as a record of my writing style and as a reflection on how it has evolved since then.

    As an A Level student now, I know how to source data properly, check calculations, and separate sloppy rhetoric from analysis. In a way, I am keeping this speech here partly because it might show how I have grown since then.

    Enjoy reading this relic from my younger self. Once you are done, you may read the [critical analysis](#fact-checking-and-critical-analysis) at the bottom of this page rather than waste time fact-checking the speech of a 14-year-old.
...
As you can probably tell, the entire speech is a *mixed* bag of some facts at best. Some of the points are solid, sourced economic points, but I *did* sweep the entire speech with many value judgements, along with some sprinkles of outright insane mathematical errors to keep my uninterested audience entertained.

### So, what does this speech get right?

1. The speech definitely touches on UK wage stagnation correctly. The [final report, "Ending Stagnation"](https://economy2030.resolutionfoundation.org/wp-content/uploads/2023/12/Ending-stagnation-final-report.pdf) from the Economy 2030 inquiry states that real wages grew around 33% per decade from 1970 to 2007, and have essentially flatlined since the 2008 financial crisis. This costs the average worker approximately £10,700 a year (relative to the pre-2008 trend). It also states that around 9 million younger workers have not known sustained pay growth.
2. According to the ONS and the previously mentioned Economy 2030 inquiry, business investment in the UK has very frequently been at the bottom of the G7 and in the bottom 10% of OECD countries.
3. It is also a well-known fact that London and the South East together account for roughly 40% of the UK's output, showing massive regional concentration in almost every sector. [This page from gov.uk](https://www.gov.uk/government/statistics/dcms-sectors-economic-estimates-regional-gva-2023/dcms-sectors-economic-estimates-regional-gross-value-added-2023?utm_source=chatgpt.com) explains all of it, and the graphs showing concentration by sector are quite interesting.
4. [Figure 4 in a survey by the ONS](https://www.ons.gov.uk/peoplepopulationandcommunity/personalandhouseholdfinances/incomeandwealth/bulletins/totalwealthingreatbritain/april2020tomarch2022) and [data from Trust for London](https://trustforlondon.org.uk/data/wealth-distribution/) both show that the people of the top decile hold about 44% of wealth.
5. NHS waiting lists really did hit the records, with the backlog peaking at 7.8M in September 2023. Even though this has slightly eased recently since the election of a new government, it still remains somewhat historically high.

### And where is it completely wrong, misleading, or unsupported?

The most funny part of this speech is likely the completely busted arithmetic when it comes to energy imports. I claimed that the UK imports "8% of its energy, 13% of which is from Russia", concluding only 0.0104% reliance on Russia. Thats a multiplication error, it should be **1.04%, not 0.0104%**. Regardless, the premise is entirely off. UK import dependancy was 35-38% in 2019-2021, and Russia accounted for 5-6% of UK energy supply in 2021 before any bans were implemented due to the 2022 Russian invasion of Ukraine.

One of the weaker claims I made was that major firms like Tesco, Sainsburys and NatWest are "registered in offshore tax havens". Strictly, this is inaccurate. Their parent companies are incorporated in the UK (as Tesco PLC, J Sainsbury PLC in England & Wales, NatWest Group PLC in Scotland). What I was really alluding to was the issue of tax avoidance. At the time, especially during this speech, I used the terms "tax evasion" and "tax avoidance" interchangeably which was an error. Evasion is genuinely illegal; avoidance is legal but controversial. These companies do indeed have offshore subsidiaries in the mentioned tax havens (quite obviously for tax avoidance), but that is not the same thing as being outright "registered offshore" for "tax evasion".

<!-- TODO: add more later, Liz truss mini budget 30bn fiscal hole, 2022 welfare spending (clarify working age benefits rather than in general BC overall it was actually double, ~£216bn, tax evasion "trillions" (false), but evasion vs avoidance clarified, 2019 conswrvative donations, resolution foundation British households poorer versus EU counterparts -->
