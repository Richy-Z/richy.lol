...
Theories that gain universal acceptance are therefore called laws (e.g., the Law of Diminishing Marginal Utility in Economics)

However, establishing laws in Economics is slightly more difficult because:

- you cannot simply set up a lab experiment - Economics is real life,
...
!!! note "Keyword"
    ...
    The first keyword to know for Economics is [ceteris paribus](../Keywords/CeterisParibus.md) - a Latin phrase which means *"all other things remain unchanged"*.
